...
(function() {
	...
	URLs.readme = 'https://api.github.com/repos/doc-metrix/disk/contents/README.md';
	URLs.markdown = 'https://api.github.com/markdown';
	URLs.doc = 'https://api.github.com/repos/doc-metrix/disk/contents/doc/index.json';

	CONTEXT = 'doc-metrix/disk';
	...
	*/
	...
	/**
	* FUNCTION: onDoc( blob )
	*	Handler for receiving a doc resource.
	*
	* @private
	* @param {String} blob - content blob which will be parsed as JSON
	*/
